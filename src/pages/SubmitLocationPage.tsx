  ...
  return (
    <div className="min-h-screen bg-app-bg text-white">
      ...
      <form onSubmit={handleSubmit} className="px-4 pb-8 space-y-4">
        ...
        {/* Name */}
        <div>
          <label className="text-sm text-muted block mb-1">Spot Name *</label>
          <input
            type="text"
            value={name}
            onChange={(e) => setName(e.target.value)}
            className="w-full bg-input-fill rounded-lg px-3 py-2.5 text-white text-sm outline-none focus:ring-2 focus:ring-white/20"
        ...
        {/* Map picker */}
        <div>
          <label className="text-sm text-muted block mb-1">Tap the map to set location</label>
        ...
        {/* Access fee */}
        <div>
          <label className="text-sm text-muted block mb-1">Access Fee ($)</label>
          <input
            type="number"
            value={accessFee}
        ...
        {/* Permission level */}
        <div>
          <label className="text-sm text-muted block mb-1">Permission Level</label>
        ...
        {/* Photos */}
        <div>
          <label className="text-sm text-muted block mb-1">Photos</label>
          <input
            ref={fileInputRef}
            type="file"
            accept="image/*"
            ...
            className="w-full text-sm text-muted file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-input-fill file:text-white"
          />
          {files.length > 0 && (
        ...
        {/* Tags */}
        <div>
          <label className="text-sm text-muted block mb-1">Tags</label>
        ...
        {/* Description */}
        <div>
          <label className="text-sm text-muted block mb-1">Notes</label>
          <textarea
            value={description}
            onChange={(e) => setDescription(e.target.value)}
            className="w-full bg-input-fill rounded-lg px-3 py-2.5 text-white text-sm outline-none focus:ring-2 focus:ring-white/20 resize-none"
            rows={3}
