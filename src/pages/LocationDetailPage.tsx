    ...
    <div className="px-4 py-4 space-y-5 lg:px-5">
      ...
      <div>
        <div className="flex items-start gap-2">
          <h1 className="font-display font-bold text-[26px] leading-[1.1] tracking-tight text-ink min-w-0 flex-1">{location.name}</h1>
          <button
            onClick={() => navigate('/locations', { state: { focusPin: location.id } })}
            className="shrink-0 mt-0.5 rounded-card border border-chip-border p-2 text-ink-mute hover:border-accent hover:text-accent active:scale-[.97] transition-all duration-100"
            title="View on map"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
